    ...
    <>
      ...
      <main className="pt-32 pb-20 flex-1 bg-[#0A192F]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12">
            <h1 className="text-4xl md:text-6xl font-black mb-4 text-white">{dict.listing_grid.rent_page_title}</h1>
            <p className="text-white/60 text-lg">{dict.listing_grid.rent_page_desc}</p>
          </div>
          
          <div className="mb-16">
            <SearchFilterControls currentLang={lang} canSearchOwner={canSearchOwner} mode="rent" />
          </div>
