              ...
              <div className="space-y-8 pt-4 border-t border-white/5">
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div className="flex flex-col">
                    <span className="text-white/40 text-[10px] font-bold uppercase tracking-widest mb-1">{t("contact_page.phone")}</span>
                    <a href="tel:+66824448989" className="text-xl md:text-2xl font-black text-white hover:text-accent transition-colors">+66 82-444-8989</a>
